...
- If the initial generated password is unavailable, use
  `scripts\reset_admin_password.py` locally. It prompts without echoing the
  password and preserves the existing users and privileges.
